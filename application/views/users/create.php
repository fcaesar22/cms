                ...
                <?= form_open('users/create') ?>
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <label>Name</label>
                                <input type="text" name="name_account" id="name_account" class="form-control" value="<?= set_value('name_account') ?>" required>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <select name="role_id" id="role_id" class="form-control" required>
                                    ...
                                    <?php foreach ($roles as $r): ?>
                                        <option value="<?= $r->id ?>" <?= set_select('role_id', $r->id) ?>><?= html_escape($r->name) ?></option>
                                    <?php endforeach; ?>
                                </select>
                            </div>
                        </div>
