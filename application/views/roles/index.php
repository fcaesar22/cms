        ...
        <div class="card">
            <div class="card-body">
                ...
                <?php if (has_permission('create_roles')): ?>
                    <a href="<?= base_url('roles/create') ?>" class="btn btn-outline-primary btn--icon-text"><i class="zmdi zmdi-collection-plus zmdi-hc-fw"></i>Add Role</a>
                <?php endif; ?>
                <br><br>
...
<script type="text/javascript">
    ...
    function loadPagination(key_search,sort_by,order_sort,rowperpage,pageno){
        $.ajax({
            url: '<?=base_url()?>roles/list_roles/'+key_search+'/'+sort_by+'/'+order_sort+'/'+rowperpage+'/'+pageno,
            type: 'get',
            dataType: 'json',
            ...
            for(index in result){
                ...
                tr += `<td>
                            <?php if (has_permission('edit_roles')): ?>
                                <a href="<?= base_url('roles/permissions/${id}') ?>" class="btn btn-outline-info btn--icon-text"><i class="zmdi zmdi-edit zmdi-hc-fw"></i>Set Permissions Role</a>
                            <?php endif; ?>
                            <?php if (has_permission('delete_roles')): ?>
                                <a href="#!" class="btn btn-outline-danger btn--icon-text" onclick="deleteConfirm('${base_url}roles/delete/${id}')"><i class="zmdi zmdi-delete zmdi-hc-fw"></i>Delete</a>
                            <?php endif; ?>
                        </td>`
                tr += "</tr>";
