                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="video_url" id="video_url" class="form-control" value="<?= set_value('video_url') ?>" placeholder="Please Input Link RSS">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select class="form-control" name="type" id="type" required>
                                    ...
                                    <option value="external" <?= set_select('type', 'external') ?>>External</option>
                                    <option value="tv" <?= set_select('type', 'tv') ?>>TV</option>
                                    <option value="vod" <?= set_select('type', 'vod') ?>>VOD</option>
                                </select>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="content_id" id="content_id" class="form-control" value="<?= set_value('content_id') ?>" placeholder="Please Input Content ID">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select class="form-control" name="target" id="target" required>
                                    <option value="">Select a type</option>
                                    <option value="_self" <?= set_select('target', '_self') ?>>Self</option>
                                    <option value="_blank" <?= set_select('target', '_blank') ?>>Blank</option>
                                </select>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="location" id="location" class="form-control" value="<?= set_value('location') ?>" placeholder="Please Input Location">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select class="form-control" name="unlimited_list" id="unlimited_list" required>
                                    <option value="Y" <?= set_select('unlimited_list', 'Y') ?>>Active</option>
                                    <option value="N" <?= set_select('unlimited_list', 'N') ?>>Inactive</option>
                                </select>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <div class="contacts__item">
                                    ...
                                    <input class="form-control" type="hidden" name="thumbnail_url" id="thumbnail_url" value="<?= set_value('thumbnail_url') ?>">
