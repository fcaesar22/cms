    ...
    <div class="content__inner">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <?= form_open('catchup_selections/create_catchup_content/'.$catchup['id']) ?>
                    <div class="row">
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select class="form-control" name="id_channel" id="id_channel" disabled>
                                </select>
                                <input type="hidden" name="id_channel_content" value="<?= set_value('id_channel_content', $catchup['id_channel']) ?>">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Category (*required)</label>&nbsp;
                                <select class="form-control" name="category_catchup" id="category_catchup" disabled>
                                </select>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="title" id="title" class="form-control" value="<?= set_value('title', $catchup['title']) ?>" placeholder="Please Input Title" disabled>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Description (*required)</label>
                                <textarea name="description" id="description" class="form-control" rows="1" placeholder="Please Input Description" disabled><?= set_value('description', $catchup['description']) ?></textarea>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Year</label>
                                <input class="form-control" type="text" name="year" id="year" value="<?= set_value('year', !empty($catchup['year']) ? $catchup['year'] : '0') ?>" placeholder="Please Input Year" oninput="this.value = this.value.replace(/[^0-9]/g, '')" onfocus="this.select()" onblur="if(this.value === '') this.value = '0';" disabled>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Rated (*required)</label>
                                <input type="text" name="rating" id="rating" class="form-control" value="<?= set_value('rating', $catchup['rating']) ?>" placeholder="ex: G, PG, PG-13, R" disabled>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Waktu Tayang (*required)</label>
                                <input type="text" name="jam_tayang" id="jam_tayang" class="form-control" value="<?= set_value('jam_tayang', $catchup['jamtayang']) ?>" placeholder="Please Input Waktu Tayang" disabled>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Duration (*required)</label>
                                <input type="text" name="durasi" id="durasi" class="form-control" value="<?= set_value('durasi', $catchup['durasi']) ?>" placeholder="Please Input Duration" disabled>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Genre (*required)</label>&nbsp;
                                <select class="form-control" name="genre[]" id="genre" multiple="multiple" disabled>
                                </select>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="cast" id="cast" class="form-control" value="<?= set_value('cast', $catchup['cast']) ?>" placeholder="Please Input Cast" disabled>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <br>
                            <button type="button" class="btn btn-light" id="btn-copy">Copy</button>
                        </div>
                        <div class="col-md-12" align="center">
                            <h4 class="card-title">Add Catch Up Content</h4>
                            <hr>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="contacts__item">
                                    <a class="contacts__img">
                                        <img id="img_thumbnail_content" src="<?=base_url()?>assets/img/defaultuploadimage.png" alt="">
                                    </a>
                                    <a class="btn btn-light callfunction" data-toggle="modal" data-target="#modal-imagethumbnail">Upload</a>
                                    <input name="thumbnail_content" id="thumbnail_content" type="hidden" class="form-control" value="<?= set_value('thumbnail_content') ?>" required>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="contacts__item">
                                    <a class="contacts__img">
                                        <img id="img_banner_content" src="<?=base_url()?>assets/img/defaultuploadimage.png" alt="">
                                    </a>
                                    <a class="btn btn-light callfunction2" data-toggle="modal" data-target="#modal-imagebanner">Upload</a>
                                    <input name="banner_content" id="banner_content" type="hidden" class="form-control" value="<?= set_value('banner_content') ?>" required>
                        ...
                        <div class="col-md-6" id="form-label">
                            <div class="form-group">
                                ...
                                <select class="form-control" name="label_content" id="label_content">
                                    ...
                                    <option value="Season" <?= set_select('label_content', 'Season') ?>>Season</option>
                                    <option value="Sequels" <?= set_select('label_content', 'Sequels') ?>>Sequels</option>
                                </select>
                        ...
                        <div class="col-md-6" id="form-episode">
                            <div class="form-group">
                                ...
                                <input type="text" name="episode_content" id="episode_content" class="form-control" value="<?= set_value('episode_content') ?>" placeholder="Please Input Title" required>
                        ...
                        <div class="col-md-6" id="form-season">
                            <div class="form-group">
                                ...
                                <input type="text" name="season_content" id="season_content" class="form-control" value="<?= set_value('season_content') ?>" placeholder="Please Input Title" required>
                        ...
                        <div class="col-md-6" id="form-trailer">
                            <div class="form-group">
                                ...
                                <input type="text" name="trailer_url" id="trailer_url" class="form-control" value="<?= set_value('trailer_url') ?>" placeholder="Please Input Title" required>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Title (*required)</label>
                                <input type="text" name="title_content" id="title_content" class="form-control" value="<?= set_value('title_content') ?>" placeholder="Please Input Title" required>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Description (*required)</label>
                                <textarea name="description_content" id="description_content" class="form-control" rows="1" placeholder="Please Input Description" required><?= set_value('description_content') ?></textarea>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Year</label>
                                <input class="form-control" type="text" name="year_content" id="year_content" value="<?= set_value('year_content', '0') ?>" placeholder="Please Input Year" oninput="this.value = this.value.replace(/[^0-9]/g, '')" onfocus="this.select()" onblur="if(this.value === '') this.value = '0';">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Rated (*required)</label>
                                <input type="text" name="rating_content" id="rating_content" class="form-control" value="<?= set_value('rating_content') ?>" placeholder="ex: G, PG, PG-13, R" required>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Waktu Tayang (*required)</label>
                                <input type="text" name="jam_tayang_content" id="jam_tayang_content" class="form-control" value="<?= set_value('jam_tayang_content') ?>" placeholder="Please Input Waktu Tayang" required>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Duration (*required)</label>
                                <input type="text" name="durasi_content" id="durasi_content" class="form-control" value="<?= set_value('durasi_content') ?>" placeholder="Please Input Duration" required>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Cast (*required)</label>
                                <input type="text" name="cast_content" id="cast_content" class="form-control" value="<?= set_value('cast_content') ?>" placeholder="Please Input Cast" required>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class='input-group date'>
                                    ...
                                    <input type="text" id="start_date_content" name="start_date_content" placeholder="Pick a date & time" class="form-control datetime-picker" value="<?= set_value('start_date_content') ?>">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class='input-group date'>
                                    <span class="input-group-addon"><i class="zmdi zmdi-calendar"></i></span>
                                    <input type="text" id="end_date_content" name="end_date_content" placeholder="Pick a date & time" class="form-control datetime-picker" value="<?= set_value('end_date_content') ?>">
                                    <i class="form-group__bar"></i>
                                </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select class="form-control" name="coming_soon_content" id="coming_soon_content" required>
                                    <option value="0" <?= set_select('coming_soon_content', '0') ?>>No</option>
                                    <option value="1" <?= set_select('coming_soon_content', '1') ?>>Yes</option>
                                </select>
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        $('#genre').select2()
        var id_channel = <?= $catchup['id_channel']; ?>;
        var title_channel = '<?= $catchup['name_channel']; ?>';
        var option = new Option(title_channel, id_channel, true, true);
        $('#id_channel').append(option).trigger('change');

        var id_category = <?= $catchup['category_catchup']; ?>;
        var title_category = '<?= $catchup['category_catchup_name']; ?>';
        var option = new Option(title_category, id_category, true, true);
        $('#category_catchup').append(option).trigger('change');

        var genre = <?= json_encode($catchup['genre']); ?>;
        ...
        if (selectedChannel) {
            $.ajax({
                ...
                if (data && data.id) {
                    ...
                    $('#id_channel_content').append(option).trigger('change');
                }
            });
        }
    ...
    $('#btn-copy').click(function() {
        ...
        var year = $("#year").val();
        $("#year_content").val(year);
        var jamtayang = $("#jam_tayang").val();
        $("#jam_tayang_content").val(jamtayang);
        var duration = $("#durasi").val();
        $("#durasi_content").val(duration);
        var rating = $("#rating").val();
        $("#rating_content").val(rating);
        var description = $("#description").val();
        $("#description_content").val(description);
        var cast = $("#cast").val();
        $("#cast_content").val(cast);
        var thumbnail = $("#img_thumbnail").attr("src");
        $("#img_thumbnail_content").attr("src", thumbnail);
        $("#thumbnail_content").val(thumbnail);
        var banner = $("#img_banner").attr("src");
        $("#img_banner_content").attr("src", banner);
        $("#banner_content").val(banner);
        var id_category_catchup = $('#category_catchup').val();
        var text_category_catchup = $('#category_catchup').select2('data')[0].text;
        var catccOption = new Option(text_category_catchup, id_category_catchup, true, true);
        $('#category_catchup_content').append(catccOption).trigger('change');
        $('#genre_content').empty();
        var genres = $('#genre').select2('data');
    ...
    $(function () {
        $("#start_date_content").flatpickr({
            ...
            allowInput: false,
            defaultDate: "<?= set_value('start_date_content') ?>"
        });
    });
    ...
    $( function() {
        $("#end_date_content").flatpickr({
            ...
            dateFormat: "Y-m-d H:i:S",
            allowInput: false,
            defaultDate: "<?= set_value('end_date_content') ?>"
        })
    });
