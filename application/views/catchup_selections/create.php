    ...
    <div class="content__inner">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <?= form_open('catchup_selections/create') ?>
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="contacts__item">
                                    <a class="contacts__img">
                                        <img id="img_thumbnail" src="<?=base_url()?>assets/img/defaultuploadimage.png" alt="">
                                    </a>
                                    <a class="btn btn-light callfunction" data-toggle="modal" data-target="#modal-imagethumbnail">Upload</a>
                                    <input name="thumbnail" id="thumbnail" type="hidden" class="form-control" value="<?= set_value('thumbnail') ?>" required>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="contacts__item">
                                    <a class="contacts__img">
                                        <img id="img_banner" src="<?=base_url()?>assets/img/defaultuploadimage.png" alt="">
                                    </a>
                                    <a class="btn btn-light callfunction2" data-toggle="modal" data-target="#modal-imagebanner">Upload</a>
                                    <input name="banner" id="banner" type="hidden" class="form-control" value="<?= set_value('banner') ?>" required>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="rating" id="rating" class="form-control" value="<?= set_value('rating') ?>" placeholder="ex: G, PG, PG-13, R" required>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="jam_tayang" id="jam_tayang" class="form-control" value="<?= set_value('jam_tayang') ?>" placeholder="Please Input Waktu Tayang" required>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="durasi" id="durasi" class="form-control" value="<?= set_value('durasi') ?>" placeholder="Please Input Duration" required>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="cast" id="cast" class="form-control" value="<?= set_value('cast') ?>" placeholder="Please Input Cast" required>
                        ...
                        <div class="col-md-6" id="form-startdate">
                            <div class="form-group">
                                ...
                                <div class='input-group date'>
                                    ...
                                    <input type="text" id="start_date" name="start_date" placeholder="Pick a date & time" class="form-control datetime-picker" value="<?= set_value('start_date') ?>">
                        ...
                        <div class="col-md-6" id="form-enddate">
                            <div class="form-group">
                                ...
                                <div class='input-group date'>
                                    <span class="input-group-addon"><i class="zmdi zmdi-calendar"></i></span>
                                    <input type="text" id="end_date" name="end_date" placeholder="Pick a date & time" class="form-control datetime-picker" value="<?= set_value('end_date') ?>">
                                    <i class="form-group__bar"></i>
                                </div>
                        ...
                        <div class="col-md-6" id="form-coomingsoon">
                            <div class="form-group">
                                ...
                                <select class="form-control" name="coming_soon" id="coming_soon" required>
                                    <option value="0" <?= set_select('coming_soon', '0') ?>>No</option>
                                    <option value="1" <?= set_select('coming_soon', '1') ?>>Yes</option>
                                </select>
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        // Hide form start time and end time Catch Up if category is not single
        $('#form-startdate').hide();
        $('#form-enddate').hide();
