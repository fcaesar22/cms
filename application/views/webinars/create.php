                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea name="email_confirmation" id="email_confirmation" class="wysiwyg-editor" required><?= set_value('email_confirmation') ?></textarea>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="text" name="vendor" id="vendor" class="form-control" value="<?= set_value('vendor') ?>" placeholder="Please Input Vendor" required>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="form-group">
                                <label class="custom-control custom-radio">
                                    <input name="flag" type="radio" class="custom-control-input" value="0" <?= set_radio('flag', '0', TRUE); ?>>
                                    <span class="custom-control-indicator"></span>
                                    <span class="custom-control-description">Free</span>
                                </label>
                                <label class="custom-control custom-radio">
                                    <input name="flag" type="radio" class="custom-control-input" value="1" <?= set_radio('flag', '1'); ?>>
                                    <span class="custom-control-indicator"></span>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="text" name="webinarID" id="webinarID" class="form-control" value="<?= set_value('webinarID') ?>" placeholder="Please Input WebinarID get from zoom" required>
                                <span class="invalid-feedback" style="display:block;"><?= form_error('webinarID') ?></span>
                            </div>
                            <a class="btn btn-light btn-sm pull-right" id="get-webinar"><i class="zmdi zmdi-search zmdi-hc-fw"></i>Get Webinar</a>
                        </div>
    ...
    $("#get-webinar").on('click', function() {
        ...
        if (webinarID != '') {
            ...
            .fail(function(resError) {
                // error response
                let errJson = resError.responseJSON
                if (typeof errJson.message !== 'undefined') {
                    alert(errJson.message)
                } else if (typeof errJson.reason !== 'undefined') {
                    alert(errJson.reason)
                }
            })
        } else {
