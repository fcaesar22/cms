    ...
    <div class="content__inner">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <?= form_open('showcases/edit/'.$showcase['id']) ?>
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <div class="contacts__item">
                                    <a class="contacts__img">
                                        <img id="img_landscape" src="<?= $showcase['poster_url'] ? $showcase['poster_url'] : base_url('assets/img/defaultuploadimage.png') ?>" alt="">
                                    </a>
                                    <a class="btn btn-light callfunction1" data-toggle="modal" data-target="#modal-imageshowcase">Upload</a>
                                    <input name="poster_url" id="poster_url" type="hidden" class="form-control" value="<?= set_value('poster_url', $showcase['poster_url']) ?>" required>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="title" id="title" class="form-control" value="<?= set_value('title', $showcase['title']) ?>" placeholder="Please input title" required>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="text" name="barcode_url" id="barcode_url" class="form-control" value="<?= set_value('barcode_url', $showcase['barcode_url']) ?>" placeholder="Please input url" required>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class='input-group date'>
                                    ...
                                    <input type="text" id="start_date" name="start_date" placeholder="Pick a date" class="form-control date-picker" value="<?= set_value('start_date', $showcase['start_date']) ?>" readonly>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class='input-group date'>
                                    <span class="input-group-addon"><i class="zmdi zmdi-calendar"></i></span>
                                    <input type="text" id="end_date" name="end_date" placeholder="Pick a date" class="form-control date-picker" value="<?= set_value('end_date', $showcase['end_date']) ?>" readonly>
                                    <i class="form-group__bar"></i>
                                </div>
...
<script type="text/javascript">
    ...
    $(function () {
        $("#start_date").flatpickr({
            dateFormat: "Y-m-d",
            allowInput: false,
            defaultDate: "<?= set_value('start_date', $showcase['start_date']) ?>"
        });
    });
    ...
    $( function() {
        $("#end_date").flatpickr({
            dateFormat: "Y-m-d",
            allowInput: false,
            defaultDate: "<?= set_value('end_date', $showcase['end_date']) ?>"
        })
    });
