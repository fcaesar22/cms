    ...
    <div class="content__inner">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <?= form_open('articles/edit/'.$article['article_id']) ?>
                    <div class="row">
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="article_by" id="article_by" class="form-control" value="<?= set_value('article_by', $article['article_by']) ?>" placeholder="Please Input By" required>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="title" id="title" class="form-control" value="<?= set_value('title', $article['article_title']) ?>" placeholder="Please Input Title" required>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <textarea name="summary" id="summary" class="form-control" rows="1" placeholder="Please Input Summary" required><?= set_value('summary', $article['article_summary']) ?></textarea>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="url_maps" id="url_maps" class="form-control" value="<?= set_value('url_maps', $article['url_google_maps']) ?>" placeholder="Please Input URL Maps">
...
<script type="text/javascript">
    var selectedCategory = <?= json_encode(array_column($article['categories'], 'keyword_id')) ?>;
    var selectedTag = <?= json_encode(array_column($article['tags'], 'keyword_id')) ?>;

    $(document).ready(function(){
        const selectedContentType = <?= json_encode($article['content_type_id']) ?>;

        $('#contentid').val(<?= $article['content_type_id'] ?>)
