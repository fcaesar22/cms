                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class='input-group date'>
                                    ...
                                    <input type="text" id="startdate_highlight" name="startdate_highlight" placeholder="Pick a date & time" class="form-control datetime-picker" value="<?= set_value('startdate_highlight') ?>">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class='input-group date'>
                                    <span class="input-group-addon"><i class="zmdi zmdi-calendar"></i></span>
                                    <input type="text" id="enddate_highlight" name="enddate_highlight" placeholder="Pick a date & time" class="form-control datetime-picker" value="<?= set_value('enddate_highlight') ?>">
                                    <i class="form-group__bar"></i>
                                </div>
                        ...
                        <div id="subdiv" class="col-md-12" style="display: none;">
                            <div class="form-group">
                                ...
                                <input type="text" name="subtitle" id="subtitle" class="form-control" value="<?= set_value('subtitle') ?>" placeholder="subtitle ex:channel name | year | episode | rating film">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="contacts__item">
                                    ...
                                    <input name="banner_highlight" id="banner_highlight" type="hidden" class="form-control" value="<?= set_value('banner_highlight') ?>" required>
                        ...
                        <div id="potdiv" class="col-md-6" style="display: none;">
                            <div class="form-group">
                                ...
                                <div class="contacts__item">
                                    ...
                                    <input name="url_image_portrait" id="url_image_portrait" type="hidden" class="form-control" value="<?= set_value('url_image_portrait') ?>">
                                    <span class="invalid-feedback" style="display:block;"><?= form_error('url_image_portrait') ?></span>
                                </div>
                            </div>
                        </div>
                        <input type="hidden" class="form-control" id='id_content' name="id_content" value="<?= set_value('id_content') ?>" required>
                        <span class="invalid-feedback" style="display:block;"><?= form_error('id_content') ?></span>
                        <input type="hidden" class="form-control" id='title_content' name="title_content" value="<?= set_value('title_content') ?>" required>
                        <span class="invalid-feedback" style="display:block;"><?= form_error('title_content') ?></span>
                        <input type="hidden" class="form-control" id='poster_content1' name="poster_content1" value="<?= set_value('poster_content1') ?>" required>
                        <span class="invalid-feedback" style="display:block;"><?= form_error('poster_content1') ?></span>
                        <input type="hidden" class="form-control" id='poster_content2' name="poster_content2" value="<?= set_value('poster_content2') ?>" required>
                        <span class="invalid-feedback" style="display:block;"><?= form_error('poster_content2') ?></span>
                        <input type="hidden" class="form-control" id='poster_content3' name="poster_content3" value="<?= set_value('poster_content3') ?>" required>
...
<script type="text/javascript">
    ...
    $(function () {
        $("#startdate_highlight").flatpickr({
            ...
            defaultDate: "<?= set_value('startdate_highlight') ?>"
        });
    ...
    $( function() {
        $("#enddate_highlight").flatpickr({
            ...
            minuteIncrement: 1,
            dateFormat: "Y-m-d H:i:S",
            defaultDate: "<?= set_value('enddate_highlight') ?>"
        })
