                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="channel_id" id="channel_id" class="form-control" value="<?= set_value('channel_id') ?>" placeholder="Please Input Source" required>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <div class="contacts__item">
                                    ...
                                    <input name="poster_content3" id="poster_content3" type="hidden" class="form-control" value="<?= set_value('poster_content3') ?>" required>
