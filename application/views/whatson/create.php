    ...
    <div class="content__inner">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <?= form_open('whatsons/create') ?>
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Title (*required)</label>
                                <input type="text" name="whatson_title" id="whatson_title" class="form-control" value="<?= set_value('whatson_title') ?>" placeholder="Please Input Title" required>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <textarea name="whatson_description" id="whatson_description" class="form-control" rows="1" placeholder="Please Input Description" required><?= set_value('whatson_description') ?></textarea>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="contacts__item">
                                    ...
                                    <input name="whatson_image" id="whatson_image" type="hidden" class="form-control" value="<?= set_value('whatson_image') ?>" required>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="contacts__item">
                                    <a class="contacts__img">
                                        <img id="img_potrait" src="<?=base_url()?>assets/img/defaultuploadimage.png" alt="">
                                    </a>
                                    <a class="btn btn-light callfunction2" data-toggle="modal" data-target="#modal-imagepotrait">Upload</a>
                                    <input name="whatson_image_potrait" id="whatson_image_potrait" type="hidden" class="form-control" value="<?= set_value('whatson_image_potrait') ?>" required>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select class="form-control" name="whatson_type" id="whatson_type" required>
                                    ...
                                    <option value="1" <?= set_select('whatson_type', '1') ?>>Text</option>
                                    <option value="2" <?= set_select('whatson_type', '2') ?>>Image</option>
                                    <option value="3" <?= set_select('whatson_type', '3') ?>>Video</option>
                                </select>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="whatson_video" id="whatson_video" class="form-control" value="<?= set_value('whatson_video') ?>" placeholder="Please Input Video">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="content_id" id="content_id" class="form-control" value="<?= set_value('content_id') ?>" placeholder="Please Input Content ID" required>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <div class='input-group date'>
                                    ...
                                    <input type="text" id="whatson_schedule" name="whatson_schedule" placeholder="Pick a date & time" class="form-control datetime-picker" value="<?= set_value('whatson_schedule') ?>">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="link_goto" id="link_goto" class="form-control" value="<?= set_value('link_goto') ?>" placeholder="Please Input Link URL">
