    ...
    <div class="content__inner">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <?= form_open('podcasts/edit/'.$podcast['podcast_id']) ?>
                    <div class="row">
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="title" id="title" class="form-control" value="<?= set_value('title', $podcast['podcast_name']) ?>" placeholder="Please Input Title" required>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="link_rss" id="link_rss" class="form-control" value="<?= set_value('link_rss', $podcast['podcast_link_rss']) ?>" placeholder="Please Input Link RSS">
...
<div class="modal fade" id="modal-subcategory" tabindex="-1" style="display: none;" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer" style="justify-content: center;">
                <input class="form-control" type="hidden" name="contentid" id="contentid" value="<?= $selected_category ?? '' ?>" required="">
