    ...
    <div class="content__inner">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <?= form_open('movies/edit/'.$movie['movie_id']) ?>
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="hidden" name="movie_code_exist" id="movie_code_exist" value="<?= set_value('title', $movie['movie_code']) ?>">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select class="form-control" name="movie_type" id="movie_type" required>
                                    ...
                                    <option value="SIN" <?= set_select('movie_type', 'SIN', $movie['movie_type'] == 'SIN') ?>>Single / Episode</option>
                                    <option value="SEA" <?= set_select('movie_type', 'SEA', $movie['movie_type'] == 'SEA') ?>>Season</option>
                                    <option value="SER" <?= set_select('movie_type', 'SER', $movie['movie_type'] == 'SER') ?>>Series Cover</option>
                                </select>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select class="form-control" name="movie_child" id="movie_child" required>
                                    ...
                                    <option value="SEA" <?= set_select('movie_child', 'SEA', $movie['movie_childtype'] == 'SEA') ?>>Season</option>
                                    <option value="SIN" <?= set_select('movie_child', 'SIN', $movie['movie_childtype'] == 'SIN') ?>>Episode</option>
                                </select>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="title" id="title" class="form-control" value="<?= set_value('title', $movie['movie_title']) ?>" placeholder="Please Input Title" required>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <textarea name="description" id="description" class="form-control" rows="1" placeholder="Please Input Description" required><?= set_value('description', $movie['movie_description']) ?></textarea>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="actor" id="actor" class="form-control" value="<?= set_value('actor', $movie['movie_actor']) ?>" placeholder="Please Input Actor" required>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="director" id="director" class="form-control" value="<?= set_value('director', $movie['movie_director']) ?>" placeholder="Please Input Director" required>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Year</label>
                                <input class="form-control" type="text" name="year" id="year" value="<?= set_value('year', !empty($movie['movie_year']) ? $movie['movie_year'] : '0') ?>" placeholder="Please Input Year" oninput="this.value = this.value.replace(/[^0-9]/g, '')" onfocus="this.select()" onblur="if(this.value === '') this.value = '0';">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="parental_guide" id="parental_guide" class="form-control" value="<?= set_value('parental_guide', $movie['movie_rating']) ?>" placeholder="ex: G, PG, PG-13, R" required>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="sequence_number" id="sequence_number" value="<?= set_value('sequence_number', !empty($movie['movie_seq']) ? $movie['movie_seq'] : '0') ?>" placeholder="Please Input Sequence Number" oninput="this.value = this.value.replace(/[^0-9]/g, '')" onfocus="this.select()" onblur="if(this.value === '') this.value = '0';">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Price</label>
                                <input class="form-control" type="text" name="price" id="price" value="<?= set_value('price', !empty($movie['movie_price']) ? $movie['movie_price'] : '0') ?>" placeholder="Please Input Price" oninput="this.value = this.value.replace(/[^0-9]/g, '')" onfocus="this.select()" onblur="if(this.value === '') this.value = '0';">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="rental_duration" id="rental_duration" value="<?= set_value('rental_duration', !empty($movie['movie_watching']) ? $movie['movie_watching'] : '0') ?>" placeholder="Please Input Rental Duration" oninput="this.value = this.value.replace(/[^0-9]/g, '')" onfocus="this.select()" onblur="if(this.value === '') this.value = '0';">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="url_trailer" id="url_trailer" class="form-control" value="<?= set_value('url_trailer', $movie['movie_trailer']) ?>" placeholder="Please Input URL Trailer">
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="form-group">
                                ...
                                <div class="btn-group btn-group--colors pcs" data-toggle="buttons">
                                    <label class="btn <?= set_checkbox('allowed_pc', '1', (bool)substr($movie['movie_allowapps'], 0, 1)) ? 'active' : '' ?>">
                                        <input name="allowed_pc" id="allowed_pc" type="checkbox" value="1" autocomplete="off" <?= set_checkbox('allowed_pc', '1', substr($movie['movie_allowapps'], 0, 1)) ?>>
                                    </label>
                                </div>
                                <label>STB</label>
                                <div class="btn-group btn-group--colors stbs" data-toggle="buttons">
                                    <label class="btn <?= set_checkbox('allowed_stb', '1', (bool)substr($movie['movie_allowapps'], 1, 1)) ? 'active' : '' ?>">
                                        <input name="allowed_stb" id="allowed_stb" type="checkbox" value="1" autocomplete="off" <?= set_checkbox('allowed_stb', '1', substr($movie['movie_allowapps'], 1, 1)) ?>>
                                    </label>
                                </div>
                                <label>Android</label>
                                <div class="btn-group btn-group--colors adrs" data-toggle="buttons">
                                    <label class="btn <?= set_checkbox('allowed_android', '1', (bool)substr($movie['movie_allowapps'], 2, 1)) ? 'active' : '' ?>">
                                        <input name="allowed_android" id="allowed_android" type="checkbox" value="1" autocomplete="off" <?= set_checkbox('allowed_android', '1', substr($movie['movie_allowapps'], 2, 1)) ?>>
                                    </label>
                                </div>
                                <label>iOS</label>
                                <div class="btn-group btn-group--colors ioss" data-toggle="buttons">
                                    <label class="btn <?= set_checkbox('allowed_ios', '1', (bool)substr($movie['movie_allowapps'], 3, 1)) ? 'active' : '' ?>">
                                        <input name="allowed_ios" id="allowed_ios" type="checkbox" value="1" autocomplete="off" <?= set_checkbox('allowed_ios', '1', substr($movie['movie_allowapps'], 3, 1)) ?>>
                                    </label>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            ...
                            <div class="form-group">
                                <label class="custom-control custom-radio">
                                    <input name="sell_methode" type="radio" class="custom-control-input" value="1" <?= set_radio('sell_methode', '1', ($movie['movie_payable'] == '1')); ?>>
                                    <span class="custom-control-indicator"></span>
                                    <span class="custom-control-description">Retail</span>
                                </label>
                                <label class="custom-control custom-radio">
                                    <input name="sell_methode" type="radio" class="custom-control-input" value="0" <?= set_radio('sell_methode', '0', ($movie['movie_payable'] == '0')); ?>>
                                    <span class="custom-control-indicator"></span>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <div class='input-group date'>
                                    ...
                                    <input type="text" id="publish_date" name="publish_date" placeholder="Pick a date & time" class="form-control datetime-picker" value="<?= set_value('publish_date', $movie['movie_date1'] . ' to ' . $movie['movie_date2']) ?>">
...
<script type="text/javascript">
    var selectedGroupKeyword = <?= json_encode(array_column($movie['group_keywords'], 'id')) ?>;

    $(document).ready(function(){
        const selectedMovieCode = <?= json_encode($movie['movie_code_init']) ?>;
        ...
        const selectedMovieParent = <?= json_encode($movie['movie_parentype']) ?>;
        ...
        const selectedMovieParentID = <?= json_encode($movie['movie_parent_id']) ?>;
    ...
    $( function() {
        $("#publish_date").flatpickr({
            mode: "range",
            dateFormat: "Y-m-d",
            defaultDate: "<?= set_value('publish_date', $movie['movie_date1'] . ' to ' . $movie['movie_date2']) ?>"
        })
